...
import PropertyCategoryStep from "./steps/PropertyCategoryStep";
...
export default function AddPropertyScreen({ navigation }: any) {
  ...
  const calculateTotalRooms = () => {
    ...
    totalRooms += propertyData.additionalRooms?.length || 0;
  ...
  const renderCurrentStep = () => {
    switch (currentStep) {
      case 0:
        return (
          <PropertyCategoryStep data={propertyData} onUpdate={updateData} />
        );
      case 1:
      ...
      <View style={styles.progressContainer}>
        ...
        {propertyData.propertyCategory && (
          <View style={styles.roomsCounterContainer}>
            <Text style={styles.roomsCounterText}>
              Rooms: {calculateTotalRooms()}
            </Text>
          </View>
        )}
      </View>
