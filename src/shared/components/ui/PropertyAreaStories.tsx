...
import AreaStoriesHeader from "../../../features/favorites/components/PropertyAreaStoriesHeader";
import AreaStoryCard, {
  AreaStory,
} from "../../../features/favorites/components/PropertyAreaStoryCard";
import { getAreaStories } from "../../../features/favorites/utils/propertyAreaUtils";
...
interface AreaStoriesProps {
  ...
  selectedArea?: typeof TelAvivLocation | null;
}
