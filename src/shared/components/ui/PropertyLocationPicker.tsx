...
export interface LocationPickerProps {
  selectedLocation?: typeof TelAvivLocation;
  onLocationSelect: (location: typeof TelAvivLocation) => void;
  style?: any;
}
...
export default function LocationPicker({
  ...
  const filteredLocations = TEL_AVIV_LOCATIONS.filter((locationName) =>
    locationName.toLowerCase().includes(searchQuery.toLowerCase())
  );

  const handleLocationSelect = (locationName: string) => {
    onLocationSelect(TelAvivLocation);
    setIsModalVisible(false);
    setSearchQuery("");
  };

  const renderLocationItem = (locationName: string) => (
    <TouchableOpacity
      key={locationName}
      style={[
        styles.locationItem,
        selectedLocation?.name === locationName && styles.selectedLocationItem,
      ]}
      ...
      >
        <View style={styles.pickerContent}>
          ...
          <View style={styles.pickerTextContainer}>
            ...
            {selectedLocation && (
              <Text style={styles.pickerSubtext}>Tel Aviv Area</Text>
            )}
          </View>
